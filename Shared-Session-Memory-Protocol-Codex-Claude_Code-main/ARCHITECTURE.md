...
Purpose
-------
This template documents a reusable spec-driven workflow for coordinating bounded sessions, context handoff, and immutable receipts between two agent tools. It is intentionally tool-agnostic and does not hard-code any project-specific values.
